...
if ~exist([rp 'analysis/fmri/glm/glm21/result'], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm21/'], 'result');
end

if ~exist([rp 'analysis/fmri/glm/glm21/result/1stlevel'], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm21/result/'], '1stlevel');
end

if ~exist([rp 'analysis/fmri/glm/glm21/result/1stlevel/' subjectName], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm21/result/1stlevel/'],subjectName);
else
    rmdir([rp 'analysis/fmri/glm/glm21/result/1stlevel/' subjectName],'s');
    mkdir([rp 'analysis/fmri/glm/glm21/result/1stlevel/'],subjectName);
end
...
matlabbatch{iJob}.spm.stats.fmri_spec.dir = ...
    {[rp 'analysis/fmri/glm/glm21/result/1stlevel/' subjectName '/']};
...
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).pmod(iPmod) = ...
    parameter.subjects(iSub).run(1).pmod(11);

iPmod = iPmod + 1;

matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).pmod(iPmod) = ...
    parameter.subjects(iSub).run(1).pmod(19);

iPmod = iPmod + 1;

matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).pmod(iPmod) = ...
    parameter.subjects(iSub).run(1).pmod(13);

iPmod = iPmod + 1;

matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).pmod(iPmod) = ...
    parameter.subjects(iSub).run(1).pmod(15);
...
matlabbatch{iJob}.spm.stats.fmri_est.spmmat = ...
    {[rp 'analysis/fmri/glm/glm21/result/1stlevel/' subjectName '/SPM.mat']};
