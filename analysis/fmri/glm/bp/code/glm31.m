%%
% glm31 TESTS THE REGIONS CORRELATING WITH
% (1) IMAGE PRESENTATION
% (2) BUTTON PRESS (main)
% (3) BUTTON PRESS (control)
%%

function glm31(subjectName)
...
if ~exist([rp 'analysis/fmri/glm/glm31/result'], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm31/'], 'result');
end

if ~exist([rp 'analysis/fmri/glm/glm31/result/1stlevel'], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm31/result/'], '1stlevel');
end

if ~exist([rp 'analysis/fmri/glm/glm31/result/1stlevel/' subjectName], 'dir')
    mkdir([rp 'analysis/fmri/glm/glm31/result/1stlevel/'],subjectName);
else
    rmdir([rp 'analysis/fmri/glm/glm31/result/1stlevel/' subjectName],'s');
    mkdir([rp 'analysis/fmri/glm/glm31/result/1stlevel/'],subjectName);
end
...
matlabbatch{iJob}.spm.stats.fmri_spec.dir = ...
    {[rp 'analysis/fmri/glm/glm31/result/1stlevel/' subjectName '/']};
...
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).name = ...
    parameter.subjects(iSub).run(1).onset(5).name;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).onset = ...
    parameter.subjects(iSub).run(1).onset(5).onset;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).duration = ...
    parameter.subjects(iSub).run(1).onset(5).duration;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).tmod = ...
    parameter.subjects(iSub).run(1).onset(5).tmod;
...
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).name = ...
    parameter.subjects(iSub).run(1).onset(6).name;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).onset = ...
    parameter.subjects(iSub).run(1).onset(6).onset;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).duration = ...
    parameter.subjects(iSub).run(1).onset(6).duration;
matlabbatch{iJob}.spm.stats.fmri_spec.sess(1).cond(iCond).tmod = ...
    parameter.subjects(iSub).run(1).onset(6).tmod;
...
matlabbatch{iJob}.spm.stats.fmri_est.spmmat = ...
    {[rp 'analysis/fmri/glm/glm31/result/1stlevel/' subjectName '/SPM.mat']};
matlabbatch{iJob}.spm.stats.fmri_est.write_residuals = 1;
